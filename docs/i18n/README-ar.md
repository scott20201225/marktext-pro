...
<h1 dir="rtl" align="center">MarkTextPro</h1>
...
<h2 dir="rtl" align="center">دعم MarkTextPro</h2>

MarkTextPro هو محرر Markdown مفتوح المصدر يعتمد على دعم مجتمعه. إذا كان MarkTextPro يُحسّن سير عملك، يُرجى التفكير في [دعم المشروع](https://github.com/scott20201225). شكراً لجميع الداعمين ❤️

**الراعي المميز**

| [<img src="../assets/sponsors/serpapi.png" width="150">](https://serpapi.com/?utm_source=marktextpro) | [استخرج نتائج Google ومحركات البحث الأخرى من خلال واجهة برمجية سريعة وسهلة وشاملة.](https://serpapi.com/?utm_source=marktextpro) |
| ------------- |:-------------|
...
يمكنك تنزيل أحدث `marktextpro-%version%.dmg` من [صفحة الإصدارات](https://github.com/scott20201225/marktext-pro/releases/latest) أو تثبيت MarkTextPro باستخدام [**homebrew cask**](https://github.com/caskroom/homebrew-cask). لاستخدام Homebrew-Cask تحتاج فقط إلى تثبيت [Homebrew](https://brew.sh/).
...
ما عليك سوى تنزيل وتثبيت MarkTextPro عبر معالج الإعداد (`marktextpro-setup-%version%.exe`) واختيار ما إذا كنت تريد التثبيت لكل مستخدم أو على مستوى الجهاز. بدلاً من ذلك، قم بتثبيت MarkTextPro باستخدام مدير الحزم مثل [Chocolatey](https://chocolatey.org/) أو [Winget](https://docs.microsoft.com/en-us/windows/package-manager/winget/).
...
يمكن تنزيل جميع الملفات الثنائية لنظام Linux وmacOS وWindows من [صفحة الإصدارات](https://github.com/scott20201225/marktext-pro/releases/latest). إذا لم يكن الإصدار متاحًا لنظامك، فيرجى فتح [مشكلة](https://github.com/scott20201225/marktext-pro/issues).

## التطوير

إذا كنت ترغب في بناء MarkTextPro بنفسك، يرجى الاطلاع على [تعليمات البناء](../dev/BUILD.md).

- [توثيق المستخدم](../README.md)
- [توثيق المطور](../dev/README.md)

إذا كانت لديك أي أسئلة بخصوص MarkTextPro، فمرحبًا بك في كتابة مشكلة. عند القيام بذلك، يرجى استخدام التنسيق الافتراضي. بالطبع، إذا قدمت طلب دمج (PR) مباشرة، فسيتم تقديره كثيرًا.

## المساهمة

MarkTextPro قيد التطوير، يرجى التأكد من قراءة [دليل المساهمة](../../.github/CONTRIBUTING.md) قبل إنشاء طلب دمج. هل تريد إضافة ميزات إلى MarkTextPro؟ راجع [خارطة الطريق](https://github.com/scott20201225/marktext-pro/projects) والمشكلات المفتوحة.


## المساهمون

شكراً لجميع الأشخاص الذين ساهموا بالفعل في MarkTextPro[[المساهمون](https://github.com/scott20201225/marktext-pro/graphs/contributors)].
